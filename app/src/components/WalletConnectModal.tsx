      ...
      <div className="p-6 sm:p-8">
        ...
        <div className="text-center">
          ...
          <button
            ...
            className="btn-glow w-full py-3.5 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-500 rounded-2xl font-semibold text-base transition-all flex items-center justify-center gap-3 shadow-lg shadow-purple-600/25 active:scale-[0.98]"
          >

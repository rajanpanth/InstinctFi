          ...
          <div className="flex items-center gap-2">
            {walletConnected && userAccount ? (
              <>
                {weeklyAvailable && (
                  <button
                    ...
                    className="px-2.5 py-1.5 bg-green-600/20 text-green-400 border border-green-600/40 rounded-lg text-xs font-semibold hover:bg-green-600/30 transition-colors animate-pulse"
                  >
                    Claim $1K
                  </button>
                )}
                <div className="px-2.5 py-1.5 bg-dark-700 border border-gray-700 rounded-lg">
                ...
                <button
                  ...
                  className="px-2.5 py-1.5 bg-dark-700 hover:bg-dark-800 border border-gray-700 rounded-lg text-sm font-mono text-gray-300 transition-colors"
              ...
              <button
                ...
                className="px-4 py-2 bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-500 hover:to-purple-600 rounded-xl font-semibold text-sm transition-all flex items-center gap-2"
              >
        ...
        <div className="flex justify-around py-2 px-2">
          <Link
            ...
            className={`text-xs font-medium py-1.5 px-3 rounded-lg ${
              pathname === "/polls" ? "text-primary-400 bg-primary-600/10" : "text-gray-500"
            }`}
          >
            Polls
          </Link>
          <Link
            href="/create"
            className={`text-xs font-medium py-1.5 px-3 rounded-lg ${
              pathname === "/create" ? "text-primary-400 bg-primary-600/10" : "text-gray-500"
            }`}
          >
            Create
          </Link>
          <Link
            href="/leaderboard"
            className={`text-xs font-medium py-1.5 px-3 rounded-lg ${
              pathname === "/leaderboard" ? "text-primary-400 bg-primary-600/10" : "text-gray-500"
            }`}
          >
            Board
          </Link>
          <Link
            href="/profile"
            className={`text-xs font-medium py-1.5 px-3 rounded-lg ${
              pathname === "/profile" ? "text-primary-400 bg-primary-600/10" : "text-gray-500"
            }`}
          >
            Profile
          </Link>

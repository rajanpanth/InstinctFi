    ...
    <div className="space-y-8 sm:space-y-12">
      ...
      {!walletConnected ? (
        <section className="text-center py-8 sm:py-14">
          <h1 className="text-3xl sm:text-5xl md:text-6xl font-extrabold mb-4 sm:mb-5">
            <span className="bg-gradient-to-r from-primary-400 via-accent-400 to-primary-400 bg-clip-text text-transparent">
              Predict. Vote. Win.
            </span>
          </h1>
          <p className="text-sm sm:text-lg text-gray-400 max-w-2xl mx-auto mb-3 sm:mb-4 px-2">
          ...
          <button
            ...
            className="px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-500 hover:to-purple-600 rounded-2xl font-bold text-base sm:text-lg transition-all transform hover:scale-105 flex items-center gap-2 sm:gap-3 mx-auto shadow-lg shadow-purple-600/25"
          >
        ...
        <section className="text-center py-6 sm:py-10">
          ...
          <div className="flex gap-2 sm:gap-3 justify-center">
            <Link href="/polls" className="px-5 sm:px-7 py-2.5 sm:py-3 bg-primary-600 hover:bg-primary-700 rounded-xl font-semibold transition-colors text-sm sm:text-base">
              Browse Polls
            </Link>
            <Link href="/create" className="px-5 sm:px-7 py-2.5 sm:py-3 bg-dark-700 hover:bg-dark-800 border border-gray-700 rounded-xl font-semibold transition-colors text-sm sm:text-base">
              Create Poll
            </Link>
          </div>
        </section>
      ...
      {polls.length === 0 && (
        <section className="text-center py-16">
          ...
          {walletConnected ? (
            <Link href="/create" className="px-6 py-3 bg-primary-600 hover:bg-primary-700 rounded-xl font-semibold transition-colors">
              Create Poll
            </Link>
          ) : (

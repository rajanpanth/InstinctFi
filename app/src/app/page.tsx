    ...
    <div className="space-y-8 sm:space-y-12">
      ...
      {!walletConnected ? (
        <section className="text-center py-10 sm:py-16 md:py-20 section-animate">
          ...
          <div className="flex items-center justify-center gap-6 mt-10 text-xs text-gray-500">
            <span className="flex items-center gap-1.5"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-green-500"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg> Non-custodial</span>
            <span className="flex items-center gap-1.5"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-blue-400"><circle cx="12" cy="12" r="10"/><path d="M12 6v6l4 2"/></svg> Instant settlement</span>
            <span className="hidden sm:flex items-center gap-1.5"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-purple-400"><path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"/></svg> Powered by Solana</span>
          </div>
        </section>
      ) : (
      ...
      <section className="pt-6 sm:pt-10 section-animate">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-5">
          {[
            { step: "1", title: "Create a Poll", desc: "Set options, price per coin, and seed the pool with your investment.", icon: "M12 5v14M5 12h14" },
            { step: "2", title: "Buy Option-Coins", desc: "Each coin = 1 vote. Pick the option you think will win.", icon: "M20.59 13.41l-7.17 7.17a2 2 0 01-2.83 0L2 12V2h10l8.59 8.59a2 2 0 010 2.82z M7 7h.01" },
            { step: "3", title: "Poll Settles", desc: "After end time, the winning option is determined by most votes.", icon: "M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10z M12 6v6l4 2" },
            { step: "4", title: "Winners Collect", desc: "Winning voters split the ENTIRE pool proportionally.", icon: "M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" },
          ].map((item) => (
